...
const Profile = props =>{
  ...
  let { loading, picture,productID,product}=props;
  console.log(product);
  let vel = {title:'',slug:'',cost_price:'',sale_price:'',inventory:'',short_des:'',product_specification:'',picture:JSON.stringify([])}
  // if(product){
  //   vel=product;
  // }
  //console.log(product);
  return(
     <Formik initialValues={vel} onSubmit={(values, {setSubmitting})=>{
